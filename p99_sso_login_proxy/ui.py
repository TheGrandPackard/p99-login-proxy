...
class ProxyUI(QMainWindow):
    ...
    def _create_eq_tab(self, notebook: QTabWidget):
        ...
        launch_options_col = QVBoxLayout()
        launch_options_col.setSpacing(0)
        launch_options_col.setContentsMargins(0, 0, 0, 0)
        launch_options_col.addWidget(self.launch_admin_cb)
        launch_options_col.addWidget(self.launch_on_start)
        eqhost_row.addLayout(launch_options_col)
